...
**`tooltipexplorer`** is a Shiny application-package for demoing and comparing five tooltip and hover-info approaches in R, powered by real financial data from [Tidy Finance](https://www.tidy-finance.org/r/) (`tidyfinance`) and [tidyquant](https://business-science.github.io/tidyquant/).
