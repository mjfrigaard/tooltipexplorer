...
`app_server()` wires the three server functions together. The outputs server returns a reactive (`perf_r`) that the download server consumes (his is the only inter-module dependency).
